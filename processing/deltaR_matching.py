'''
From here https://github.com/PocketCoffea/PocketCoffea
NOT MY CODE
'''
...
def object_matching(obj, obj2, dr_min, dpt_max=None, return_indices=False):
    ...
    deltaR = ak.flatten(vecs1.metric_table(vecs2), axis=2)
    ...
    if return_indices:
        ...
        return matched_obj, matched_obj2, deltaR_padnone, idx_obj_padnone, idx_obj2_padnone
    else:
